...
//        String stringresult = sRetrive.plus(100);
        when(sRetrive.plus(anyInt())).thenReturn("Test") ;
        when(sRetrive.plus(100)).thenReturn("200") ;
        //when(sRetrive.plus(50)).thenReturn("50") ;

        String stringresult1 = sRetrive.plus(70);
        String stringresult2 = sRetrive.plus(100);
        String stringresult3 = sRetrive.plus(50);

        //输入22，指定plus方法返回“Hello world”

        Assert.assertEquals("Test", sRetrive.plus(70)) ;    // ????
        System.out.println(stringresult1);
        Assert.assertEquals("200", sRetrive.plus(100)) ;    // ????
        System.out.println(stringresult2);
        Assert.assertEquals("Test", sRetrive.plus(50)) ;    // ????
